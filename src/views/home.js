...
const Home = (props) => {
  ...
  return (
    <>
      <div className=" bg-white overflow-hidden min-h-full lg:flex lg:flex-row-reverse lg:items-center lg:justify-center">
        <div className="md:flex md:justify-center">
          <img
            className="object-cover sm:h-72 md:h-96 lg:mx-8"
            src={Hero}
            alt="hero-image"
          />
        </div>
